...
ForIndexRange
  = name:Identifier __ InToken __ range:Identifier {return {type:"Range", source:range}}
  / name:Identifier __ InToken __ "[" __ range:ForIndexRangeDuplet __ "]" {return {type: "Range", name:name, range:range }}

ForIndexRangeDuplet
  = exp:Expression __ ".." __ exp2:Expression  { return {type:"RangeDuplet", exp:exp, exp2:exp2 }}
