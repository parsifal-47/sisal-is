...
ReplaceToken    = "replace"          !IdentifierPart
TagToken        = "tag"              !IdentifierPart
...
TypeRenaming
	= TypeToken __ name:Identifier __ "=" __ t:TypeItself {return {type:"TypeRenaming", name:name, dtype:t}}
...
TypeItself
  ...
  / RecordToken __ "[" __ f:FieldList __ "]" {return {type:"Record", fields:f}}
  / Identifier
...
IdWithType
	= ids:IdentifierList __ ":" __ t:TypeItself { return {type:"TypedIdList", ids:ids, dtype:t }}

FieldList
  = head:IdWithType
    tail:(__ ";" __ IdWithType)* {
      var result = [head];
      for (var i = 0; i < tail.length; i++) {
        result.push(tail[i][3]);
      }
...
FunctionDefinition
	= FunctionToken __ name:Identifier __ "[" __ t:TypeList __ ReturnsToken __ t2:TypeList __ "]" {return {type: "Function", name:name, params:t, returns: t2}}
	/ FunctionToken __ name:Identifier __ "[" __ ReturnsToken __ t2:TypeList __ "]" {return {type:"Function", name:name, params:null, returns: t2}}
	/ FunctionToken __ name:Identifier __ "(" __ t:FieldList __ ReturnsToken __ t2:TypeList __ ")" {return {type: "Function", name:name, params:t, returns: t2}}
	/ FunctionToken __ name:Identifier __ "(" __ ReturnsToken __ t2:TypeList __ ")" {return {type:"Function", name:name, params:null, returns: t2}}

FunctionImplementation
	= FunctionToken __ name:Identifier __ "(" __ t:FieldList __ ReturnsToken __ t2:TypeList __ ")" __ exp:ExpressionList __ EndToken __ FunctionToken {return {type: "Function", name:name, params:t, returns: t2, expressions:exp}}
	/ FunctionToken __ name:Identifier __ "(" __ ReturnsToken __ t2:TypeList __ ")" __ exp:ExpressionList __ EndToken __ FunctionToken {return {type: "Function", name:name, params:null, returns: t2, expressions:exp}}
...
ArrayItself
  = (ArrayToken __ "[" __ t:TypeItself __ "]" __)? "[" __ contents:ExpressionList __ "]"
/* ===== A.3 Expressions ===== */
...
Operand
  ...
  / Identifier
	/ FunctionToken __ name:Identifier (__ "[" __ types:TypeList __ "]")? {return {type:"Function", name:name, types:types }}
/*	/ Operation */
	/ Literal
	/ LetExpression
	/ IfExpression
...
/*	/ StreamItself
	...
	/ TypeToken __ "(" __ ex:Expression __ ")" {return {type:"Typeex", expression:ex }}
	/ TypeToken __ "[" __ ty:DataType __ "]" {return {type:"Type", dtype:ty }}
	/ ErrorToken __ "[" __ ty:DataType __ "]" {return {type:"Error", dtype:ty}}

/* Complex Expressions */
LetExpression
	= LetToken __ dl:DefinitionList __ InToken __ exp:ExpressionList __ EndToken __ LetToken {
...
LValue
	= head:NameAndMaybeType
    tail:(__ "," __ NameAndMaybeType)* {
      var result = [head];
      for (var i = 0; i < tail.length; i++) {
        result.push(tail[i][3]);
      }
...
IfExpression
	= IfToken __ exp:Expression __ ThenToken __ th:ExpressionList __ elif:(ElseIfs)? __ ElseToken __ el:ExpressionList __ EndToken __ IfToken {return {type:"If", condition: exp, then:th, elseif:elif, else:el }}
...
ElseIf
  = ElseIfToken __ exp:Expression __ ThenToken __ th:ExpressionList
...
LoopExpression
	...
	/ ForToken __ InitialToken __ init:DefinitionList expr:( __ WhileToken __ Expression)? body:( __ RepeatToken __ DefinitionList )? postcond:( __ WhileToken __ Expression)? __ ReturnsToken __ ret:ReturnExpression __ EndToken __ ForToken
