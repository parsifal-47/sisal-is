...
FunctionDefinition
  = name:Identifier __ "=" __ body:FunctionItself {return {type: "Function", name: name, params: body.params, body: body.expressions};}

FunctionItself
  = FunctionToken __ "(" __ t:IdentifierList __ ")" __ IndentToken __ exp:ExpressionList __ DedentToken {return {type: "Function", params:t, expressions:exp}}
  / FunctionToken __ "(" __ ")" __ IndentToken __ exp:ExpressionList __ DedentToken {return {type: "Lambda", params:null, expressions:exp}}
...
PostfixOperation
  = base:Operand
    args:(
     ...
     / __ "." __ name:IdentifierName    { return {type:"Dot", field:name}; }
     / __ "[" __ expList:ExpressionList __ "]" { return {type:"[]", contents: expList}; }
    )* {
  ...
  / "(" __ exp:ExpressionList __ ")" {
      if (exp.length > 1)
        return {type:"Tuple", contents:exp};
      else return exp[0];
    }
  / Operand
...
FunctionCall
  = name:Identifier __ "(" __ params:ExpressionList __ ")" {
      return {type: "Call", name: name, contents: params};
    }

/* Complex Expressions */
LetExpression
  = LetToken __ IndentToken __ dl:DefinitionList __ DedentToken __ InToken __ IndentToken __ exp:ExpressionList __ DedentToken {
...
IfExpression
  = IfToken __ exp:Expression __ IndentToken __ th:ExpressionList __ DedentToken __ elif:(ElseIfs)? __ ElseToken __ IndentToken __ el:ExpressionList __ DedentToken {return {type:"If", condition: exp, then:th, elseif:elif, else:el }}
...
ElseIf
  = ElseIfToken __ exp:Expression __ IndentToken __ th:ExpressionList __ DedentToken { return {type: "If", condition:exp, then: th, else: null, elseif: null}; }

LoopExpression
  =  ForToken __ r:RangeGen repeat:(__ RepeatToken)? dl:( __ IndentToken __ DefinitionList __ DedentToken)? __ ReturnsToken __ ret:ReturnExpression __
    {return {type: "ForAll", range:r, body:(dl!==null?dl[3]:""), returns:ret}}
  / ForToken __ r:RangeGen dl:( __ RepeatToken __ DefinitionList)? __ ReturnsToken __ ret:ReturnExpression __ {
    return {type: "ForAll", range:r, body:null, returns:ret}
    }
  / ForToken init:(__ InitialToken __ IndentToken __ DefinitionList __ DedentToken)? expr:( __ WhileToken __ Expression)? repeat:(__ RepeatToken)? body:( __ IndentToken __ DefinitionList __ DedentToken )? postcond:( __ WhileToken __ Expression)? __ ReturnsToken __ ret:ReturnExpression __
    {return {type: "For", init:(init!==null?init[5]:null), condition:(expr!==null?expr[3]:null), postcondition:(postcond!==null?postcond[3]:null), body:(body!==null?body[3]:null), returns:ret }}
  / ForToken __ WhileToken __ expr:Expression body:( __ RepeatToken __ DefinitionList )? __ ReturnsToken __ ret:ReturnExpression
    {return {type: "For", init:null, condition:expr, body:(body!==null?body[3]:null), postcondition: null, returns:ret }}
  / ForToken __ RepeatToken __ body:DefinitionList __ WhileToken __ expr:Expression __ ReturnsToken __ ret:ReturnExpression {return {type: "For", init:null, condition:expr, postcondition: null, body:body, returns:ret }}

RangeGen
  = name:Identifier __ InToken __ range:Identifier atidx:(__ "at" __ IdentifierList)? {return {type:"RangeFromSource", left:name, source:range, at:atidx}}
  / names:IdentifierList __ InToken __ ranges:RangeList {return {type: "RangeList", names:names, ranges:ranges }}

RangeList
  = head:RangeItself
    tail:(__ "," __ RangeItself)* {
      var result = [head];
      for (var i = 0; i < tail.length; i++) {
        result.push(tail[i][3]);
      }
...
RangeItself
  = "[" __ exp:Expression __ ".." __ exp2:Expression __ "]"  { return {type:"Range", left:exp, right:exp2 }}
