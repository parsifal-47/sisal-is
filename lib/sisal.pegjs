...
FunctionDefinition
  = name:Identifier __ "=" __ body:FunctionItself {return {type: "FuncDef", body: body};}
...
PostfixOperation
  ...
  / "(" __ exp:ExpressionList __ ")" {return {type:"tupleornot", exp:exp}; }
  / Operand
...
FunctionCall
  = name:Identifier __ "(" __ params:IdentifierList __ ")" {
...
LoopExpression
  ...
  / ForToken init:(__ InitialToken __ IndentToken __ DefinitionList __ DedentToken)? expr:( __ WhileToken __ Expression)? repeat:(__ RepeatToken)? body:( __ IndentToken __ DefinitionList __ DedentToken )? postcond:( __ WhileToken __ Expression)? __ ReturnsToken __ ret:ReturnExpression __
    {return {type: "For", init:(init!==null?init[5]:""), condition:(expr!==null?expr[3]:""), postcondition:(postcond!==null?postcond[3]:""), body:(body!==null?body[3]:""), returns:ret }}
...
RangeGen
  = name:Identifier __ InToken __ range:Identifier atidx:(__ "at" __ IdentifierList)? {return {type:"Range", source:range, at:atidx}}
  / names:IdentifierList __ InToken __ range:RangeList {return {type: "Range", names:names, range:range }}
...
RangeItself
  = "[" __ exp:Expression __ ".." __ exp2:Expression __ "]"  { return {type:"RangeDuplet", exp:exp, exp2:exp2 }}
